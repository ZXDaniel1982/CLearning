#line 1 "D:/MyProject/SPC code1/SPC code/I2C.c"
...
#line 15 "D:/MyProject/SPC code1/SPC code/I2C.c"
char I2CError=0;
...
#line 170 "D:/MyProject/SPC code1/SPC code/I2C.c"
void I2C_get(UCHAR QTAddress,UCHAR QTRegister,UCHAR *Keystate,UCHAR Length)
{
 char j;

 I2CStart();
 I2CSendByte((QTAddress << 1) +  0 );
...
#line 219 "D:/MyProject/SPC code1/SPC code/I2C.c"
...
{
 char i;
#line 233 "D:/MyProject/SPC code1/SPC code/I2C.c"
 I2CStart();
 I2CSendByte(QTAddress * 2 +  0 );
 I2CSendByte(QTRegister);
...
{
 UCHAR SSP1CON2_Idel;
 SSP1CON2_Idel =  0x80  + RSEN +  0x20  +  0x10  +  0x08 ;
