...
/**
  ...
  * @param  sdio : Pointer to SDIO register base  
  * @param  intrupt : specifies the SDIO interrupt sources to be enabled.
  ...
  * @retval None
  */
#define __SDIO_ENABLE_IT(sdio, intrupt)  ((sdio)->MASK |= (intrupt))

/**
  * @brief  Disable the SDIO device interrupt.
  * @param  sdio : Pointer to SDIO register base   
  * @param  intrupt : specifies the SDIO interrupt sources to be disabled.
  *          This parameter can be one or a combination of the following values:
  *            @arg SDIO_IT_CCRCFAIL: Command response received (CRC check failed) interrupt
  *            @arg SDIO_IT_DCRCFAIL: Data block sent/received (CRC check failed) interrupt
  *            @arg SDIO_IT_CTIMEOUT: Command response timeout interrupt
  ...
  * @retval None
  */
#define __SDIO_DISABLE_IT(sdio, intrupt)  ((sdio)->MASK &= ~(intrupt))
...
/**
  ...
  */
#define __SDIO_GET_FLAG(sdio, flag)  (((sdio)->STA &(flag)) != RESET)
...
/**
  ...
  * @retval None
  */
#define __SDIO_CLEAR_FLAG(sdio, flag)  ((sdio)->ICR = (flag))

/**
  * @brief  Checks whether the specified SDIO interrupt has occurred or not.
  * @param  sdio : Pointer to SDIO register base   
  * @param  intrupt: specifies the SDIO interrupt source to check. 
  *          This parameter can be one of the following values:
  *            @arg SDIO_IT_CCRCFAIL: Command response received (CRC check failed) interrupt
  *            @arg SDIO_IT_DCRCFAIL: Data block sent/received (CRC check failed) interrupt
  *            @arg SDIO_IT_CTIMEOUT: Command response timeout interrupt
  ...
  */
#define __SDIO_GET_IT  (sdio, intrupt)  (((sdio)->STA &(intrupt)) == (intrupt))

/**
  * @brief  Clears the SDIO's interrupt pending bits.
  * @param  sdio : Pointer to SDIO register base 
  * @param  intrupt: specifies the interrupt pending bit to clear. 
  *          This parameter can be one or a combination of the following values:
  *            @arg SDIO_IT_CCRCFAIL: Command response received (CRC check failed) interrupt
  *            @arg SDIO_IT_DCRCFAIL: Data block sent/received (CRC check failed) interrupt
  *            @arg SDIO_IT_CTIMEOUT: Command response timeout interrupt
  ...
  * @retval None
  */
#define __SDIO_CLEAR_IT(sdio, intrupt)  ((sdio)->ICR = (intrupt))
