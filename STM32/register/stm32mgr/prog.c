...
int main(int argc, char **argv)
{
    ...
    char filename[255] = "/home/dzhang/workspace/CLearning/STM32/register/stm32app/build/stm32app.bin";
...
static bool SendData(uint8_t *rbuf, uint8_t *tbuf, int fd)
{
    ...
    tbuf[16] = (uint8_t)((chksum >> 8) & 0x00ff);
    tbuf[17] = (uint8_t)(chksum & 0x00ff);
